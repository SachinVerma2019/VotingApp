...
export const UserLandingPage = () => {
  ...
  const onSubmitPollClicked = async () => {
    ...
    console.log("poll option : " +  JSON.stringify(options));
    ...
    <Container>
      ...
      <Accordion>
          <AccordionSummary
            ...
            id="panel1a-header"
          >
            <Typography><h4>Expand To Create A New Poll</h4></Typography>
          </AccordionSummary>
          <AccordionDetails>
            <div className="content-container">
              ...
              <hr />
              <button
                disabled={!pollTopic || !pollOptions || pollOptions.indexOf('|') === -1}
